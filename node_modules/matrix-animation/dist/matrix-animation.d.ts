export declare class MatrixAnimation {
    ...
    canvasWidth: number;
    canvasHeight: number;
    availableCharSets: any[];
    raindrops: MatrixRaindrop[];
    private mutationObserver;
    private resizeObserver;
    private performCanvasShift;
    stopAnimation: boolean;
    private hasCreatedCanvas;
    rainWidth: number;
    /**
     *
     ...
     */
    constructor(selector: string | HTMLElement, options?: MatrixOptions);
    /**
...
export declare type MatrixOptions = Partial<MatrixRaindropOptions & {
    /**
...
declare class MatrixRaindrop {
    x: number;
    y: number;
    private matrixAnimation;
    config: MatrixRaindropOptions;
    private charList;
    private trailChars;
    ...
    constructor(x: number, y: number, matrixAnimation: MatrixAnimation, config?: MatrixRaindropOptions);
    private initConfig;
    initMoveDirection(): void;
    randomizeChars(): void;
    onRespawn(): void;
...
export declare type MatrixRaindropInstanceOptions = Partial<MatrixRaindropOptions & {
    x: number;
    y: number;
    /**
     * TBD.
...
export declare type MatrixRaindropOptions = Partial<{
    /**
...
export declare type MatrixRainGeneratorOptions = Partial<{
    /**
